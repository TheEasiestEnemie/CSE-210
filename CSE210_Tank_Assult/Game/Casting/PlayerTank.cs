...
namespace CSE210_Assult.Game.Casting
{
    public class PlayerTank: Actor {
        ...
        public override void DrawImage()
        {
            ...
            double angle = VectorCalculation.GetAngle(new Vector2(0,-1), mouseVector);
            ...
            Raylib.DrawTextureTiled(this.texture, source, rect, origin, (float)rotationAngle, 1, Raylib_cs.Color.WHITE);
